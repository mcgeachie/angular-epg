...
fangApp.controller('TvGuideCtrl', ['$scope', '$http', function($scope, $http) {
    $http.get('/api/channel/index/4101-1').success(function (data) {
        ...
        $http.get('/api/programme/channel/2002,2006,6000,1621,1801,4061,4066,4053,3810,2304,3809,4056,4080,4074,2061,2018,6532,6533,6534,1833,2002/2013-02-21/0.json').success(function (data) {
